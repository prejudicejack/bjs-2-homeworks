describe("Домашнее задание к занятию 2 Функции", () => {
  ...
  describe("Задача №3 Другая насадка", () => {
    it("[[10, 20, 30], [-40, -50, -65]] => 25", () => {
      expect(makeWork2([[10, 20, 30], [-40, -50, -65]], worker2)).toEqual(25);
    })
    it("[[10, 10, 11], [20, 10]] => 10", () => {
      expect(makeWork2([[10, 10, 11], [20, 10]], worker2)).toEqual(10);
    })
    it("[[0, 1, 2], [-1, -100]] => 99", () => {
      expect(makeWork2([[0, 1, 2], [-1, -100]], worker2)).toEqual(99);
    })
